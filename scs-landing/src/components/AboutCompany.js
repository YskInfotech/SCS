...
const AboutCompany = () => {
  return (
    <div className="about-container container my-5" id="about">
...
<br/>
     ...
     <div className="row justify-content-center text-center mt-5 g-5">
  ...
  <div className="col-12 col-md-6 col-lg-5 mb-4">
    <div className="outer-info-card">
      ...
      <div className="card-inner d-flex align-items-center p-4">
        <img src={visionIcon} alt="Vision" className="side-icon me-4" />
        <p className="text-start text-muted mb-0">
          To redefine how brands communicate their value by creating
          breathtaking visuals tailored for the global audience.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="col-12 col-md-6 col-lg-5 mb-4">
    <div className="outer-info-card">
      ...
      <div className="card-inner d-flex align-items-center p-4">
        <img src={missionIcon} alt="Mission" className="side-icon me-4" />
        <p className="text-start text-muted mb-0">
          To help brands succeed through stunning visuals,
          powerful branding, and content that connects with their audience.
        </p>
      </div>
    </div>
  </div>
